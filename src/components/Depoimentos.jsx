...
function Depoimentos() {
  ...
  return (
    <section id="depoimentos" className="py-16 md:py-20 lg:py-24 px-3 md:px-6 lg:px-8 bg-gradient-to-b from-white via-neutral-50/30 to-white">
      <div className="max-w-7xl mx-auto">
        ...
        <div>
          ...
          {/* Desktop: Grid */}
          <div className="hidden md:grid md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12 xl:gap-16 2xl:gap-20">
            {depoimentos.map((depoimento, index) => (
              <div
                key={index}
                onClick={() => setSelectedVideoIndex(index)}
                className="group bg-white/90 backdrop-blur-xl p-8 md:p-10 lg:p-12 xl:p-14 2xl:p-16 rounded-3xl border-2 border-white/40 shadow-2xl hover:shadow-green-500/30 transition-all duration-500 hover:-translate-y-3 relative overflow-hidden cursor-pointer"
                role="button"
                tabIndex={0}
                onKeyDown={(e) => {
                  if (e.key === 'Enter' || e.key === ' ') {
              ...
              >
                ...
                <div className="relative z-10">
                  ...
                  {/* Nome da cliente */}
                  <p className="text-neutral-900 font-light tracking-wide text-base lg:text-lg xl:text-xl 2xl:text-2xl text-center">
                    — {depoimento.nome}
                  </p>
                </div>
              </div>
