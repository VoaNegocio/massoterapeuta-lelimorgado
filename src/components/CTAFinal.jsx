      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        ...
        <div>
          ...
          >
            ...
            <span className="relative z-10 drop-shadow-lg font-extrabold">Agende sua sessão personalizada agora mesmo!</span>
          </a>
        </div>
      </div>
    </section>
