  ...
  return (
    <section id="cta-final" className="py-16 md:py-32 px-3 md:px-4 bg-gradient-to-br from-green-50/80 via-emerald-50/60 to-green-100/40 relative overflow-hidden">
      ...
      <div className="max-w-5xl mx-auto text-center relative z-10">
        {/* Título */}
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-light tracking-wider text-neutral-900 mb-6 md:mb-8">
          Não Espere Mais! Comece a Tratar Suas Dores Agora!
        </h2>

        {/* Texto */}
        <p className="text-lg md:text-2xl text-neutral-700 leading-relaxed mb-10 md:mb-12 max-w-4xl mx-auto font-light tracking-wide">
        ...
        <div>
          ...
          >
            ...
            <svg
              className="w-7 h-7 md:w-8 md:h-8 relative z-10 drop-shadow-lg animate-bounce-slow"
              fill="currentColor"
              viewBox="0 0 24 24"
            >
