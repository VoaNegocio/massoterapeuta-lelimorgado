  ...
  return (
    <footer className="bg-gradient-to-br from-neutral-900 via-neutral-800 to-neutral-900 text-neutral-300 py-12 md:py-20 px-3 md:px-4 border-t border-neutral-700/50">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-16 mb-10 md:mb-12">
          ...
          <div>
            ...
            <a
              ...
              className="group inline-flex items-center gap-3 text-green-400 hover:text-green-300 transition-all duration-300 font-semibold text-lg mb-6"
            >
              <svg
        ...
        {/* Copyright */}
        <div className="border-t border-neutral-700/50 pt-10 text-center text-neutral-500 text-sm">
