        ...
        <div className="text-center space-y-6 md:space-y-12">
          ...
          <div className="pt-6 md:pt-8">
            ...
            >
              ...
              <span className="relative z-10 drop-shadow-lg font-extrabold">Quero agendar uma sessão personalizada!</span>
            </a>
          </div>
